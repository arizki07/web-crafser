                ...
                <div class="w-full px-4">
                    <div class="text-center">
                        ...
                        <p class="mb-5 text-base text-body-color dark:text-dark-6">
                            Team Developers Web Crafter Service IT Service dan Consultans.
                        </p>
    ...
    <section id="contact" class="relative py-20 md:py-[120px]">
        ...
        <div class="container px-4">
                            ...
                            <div class="mb-8 flex w-[330px] max-w-full">
                                ...
                                <div>
                                    ...
                                    <p class="text-base text-body-color dark:text-dark-6">
                                        ...
                                        <a href="https://g.co/kgs/YUAefei" class="text-primary" target="_blank">Kunjungi
                                            Informasi Web Crafser di Google</a>
                                    </p>
                                </div>
                            </div>
                            <div class="mb-8 flex w-[330px] max-w-full">
                                ...
                                <div>
                                    <h5 class="mb-[18px] text-lg font-semibold text-dark dark:text-white">Hubungi Kami</h5>
                                    <p class="text-base text-body-color dark:text-dark-6">
                                        <i class="fas fa-envelope"></i>&nbsp; <a
                                            href="mailto:cp@webcrafser.com">cp@webcrafser.com</a>
                                    </p>
                                    <p class="mt-1 text-base text-body-color dark:text-dark-6">
                                        <i class="fas fa-envelope"></i>&nbsp; <a
                                            href="mailto:cp@webcrafser.com">webcrafser@gmail.com</a>
                                    </p>
                                    <p class="mt-1 text-base text-body-color dark:text-dark-6">
                                        ...
                                        <a href="https://api.whatsapp.com/send?phone=6282129967454&text=Saya%20ingin%20konsultasi%2C%20apakah%20ini%20dengan%20Web%20Crafser%20Cirebon%3F"
                                            class="mt-1 text-base text-body-color dark:text-dark-6" target="_blank">
                                            +62821-2996-7454
                                        </a>
                                    </p>
                                </div>
			...
			">
                        ...
                        <form>
                            <div class="mb-[22px]">
                                <label for="fullName" class="mb-4 block text-sm text-body-color dark:text-dark-6">Nama
                                    Lengkap*</label>
                                <input type="text" name="fullName" placeholder="Ahmad Syarif Pangestu"
                            ...
                            <div class="mb-[22px]">
                                <label for="email" class="mb-4 block text-sm text-body-color dark:text-dark-6">Email
                                    Aktif*</label>
                            ...
                            <div class="mb-[22px]">
                                <label for="phone" class="mb-4 block text-sm text-body-color dark:text-dark-6">No
                                    Handphone*</label>
                                <input type="text" name="phone" placeholder="0898876xxxx"
                                    class="w-full border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-body-color placeholder:text-body-color/60 focus:border-primary focus:outline-none dark:border-dark-3 dark:text-dark-6"
                                    disabled />
                            </div>
                            <div class="mb-[30px]">
                                <label for="message"
                                    class="mb-4 block text-sm text-body-color dark:text-dark-6">Pesan*</label>
                                <textarea name="message" rows="1" placeholder="Ketik pesan anda disini..."
