<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark" style="margin-top: 2px">
            <a href="{{ route('dashboard') }}" style="margin-right: 2px">
                <img src="{{ asset('assets/static/crafser.jpg') }}" alt=""
                    style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;">
            </a>
            <a href="{{ route('dashboard') }}"
                style="margin-top: 3px; font-size: 16px; display: inline-block; vertical-align: middle;">
                WEB CRAFSER
            </a>
        </h1>
